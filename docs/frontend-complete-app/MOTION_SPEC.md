...
本文是 P0 阶段"动效和交互规范"。归并现有 `frontend-demo-optimized/MOTION_*.md` 文档到 contracts/ 权威源，定义 P0 MotionId 集合、触发/结束/打断规则、reduced-motion 降级、手势阈值、demo 等价性边界。
...
4. 在 [MOTION_EFFECTS.md](../frontend-demo-optimized/MOTION_EFFECTS.md) 补视觉效果描述。
