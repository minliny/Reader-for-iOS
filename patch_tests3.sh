...
sed -i.bak '/return ReadingFlowCoordinator(/,/errorLogger: InMemoryErrorLogger()/d' /workspace/iOS/Tests/ShellSmokeTests/ReaderFlowFunctionalValidationTests.swift
...
sed -i.bak '/return ReadingFlowCoordinator(/,/errorLogger: InMemoryErrorLogger()/d' /workspace/iOS/Tests/ShellSmokeTests/ReaderFlowHardeningTests.swift
